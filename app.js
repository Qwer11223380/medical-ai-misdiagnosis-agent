...
const STAGE_EVIDENCE = {
  1: {
    narrative:
      "",
    caseText: [
      "患者，男性，61 岁。因“发现右颊部肿物半年余”入院。",
      "患者半年余前发现右颊部一“黄豆”大小肿物，无疼痛、出血等不适。一直行药物治疗，疗效不佳。这半年来肿物逐渐增大，现增大至“山核桃”大小。",
      ...
      "门诊局部肿物切取活检，行病理切片（图 1、2）。",
      "入院后完善常规检查，行“右颊部肿物切除术”。因术前已行局部肿物切取活检，故完整切除标本未行病理检查。"
    ],
    images: [
